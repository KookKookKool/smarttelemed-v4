    ...
    return Row(
      children: [
        ClipRRect(
          ...
          child: Image.asset(
            ...
            errorBuilder: (_, __, ___) =>
                const SizedBox(width: 36, height: 36, child: Icon(Icons.local_hospital)),
          ),
        ),
        ...
        const Column(
          ...
          children: [
            Text('โรงพยาบาลอีเอสเอ็ม',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700)),
            SizedBox(height: 2),
            Text('E.S.M Solution Hospital',
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Row(
            children: weekLetters
                .map((w) => Expanded(
                      child: Center(
                        child: Text(w, style: const TextStyle(color: Colors.black54)),
                      ),
                    ))
                .toList(),
          ),
        ...
        GridView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            return LayoutBuilder(builder: (_, cellC) {
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: const [
        ...
        _QuickAction(icon: Icons.calendar_month_outlined, label: 'นัดหมาย', routeName: '/appointment'),
      ],
    );
  }
}
